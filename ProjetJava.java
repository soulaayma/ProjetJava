...
public class ProjetJava extends JFrame {
	...
	public ProjetJava() {
		...
		JLabel lblNewLabel = new JLabel("Location de voiture");
				...
				Class.forName("com.java.jdbc.Driver");
				  ...
				  if(rs.next()) {
					  if(((day1.getSelectedItem().toString()=="31")&&(month1.getSelectedItem().toString()=="02"||"04"||"06"||"09"||"11"))||(day2.getSelectedItem().toString()=="31")&&(month2.getSelectedItem().toString()=="02"||"04"||"06"||"09"||"11"))
						  ...
						  String date1= day1.getSelectedItem().toString()+"/"+month1.getSelectedItem().toString()+"/" + year1.getSelectedItem().toString();
						  String date2= day2.getSelectedItem().toString()+"/"+month2.getSelectedItem().toString()+"/" + year2.getSelectedItem().toString();
						  pst = DBConnection.getConnection().prepareStatement("INSERT INTO location (Id, DateDebut, DateFin, ModePayement) VALUES (? ,? ,?,?)"); 
					      stm2.setString(1,textField.getText());
						  stm2.setString(2,date1);
						  stm2.setString(4,date2);
						  stm2.setString(4,methodepayement.getText());
					      ResultSet rs = stm1.executeQuery(sql1);
					  } }
				  else 
